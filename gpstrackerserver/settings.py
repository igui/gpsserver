"""
Django settings for gpstrackerserver project.
...
ROOT_URLCONF = 'gpstrackerserver.urls'
...
WSGI_APPLICATION = 'gpstrackerserver.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': environ.get('DB_PATH', os.path.join(BASE_DIR, 'db.sqlite3')),
    }
}
